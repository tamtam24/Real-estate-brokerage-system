        ...
        <div class="content">
            <div class="content-title">
                <div class="title-cover">
                    ...
                    <span id="title2">Tổng hợp các BĐS tại TP Hồ Chí Minh hot nhất hiện tại</span>
                </div>
            </div>
            <div class="content-product ">
                <div class="container">
                    <div class="content1 justify-content-center">
                        <div class="row">
                            <c:forEach var="building" items="${buildingList.listResult.subList(0, 3)}">
        ...
        <div class="content3">
            <div class="container">
                <div class="text-center">
                    <a class="content3-title">Bất động sản xem nhiều</a>
                </div>
                <div class="content3-product justify-content-center">
                    <div class="row">
                        <c:forEach var="building" items="${buildingList.listResult.subList(0, 4)}">
                            <div class="col-12 col-md-3">
                                <div class="product2">
                                    ...
                                    <div class="form-inner">
                                        <form class="a-center"
                                            ...
                                            <button class="button-subscribe button-45 subscribe" name="subscribe"
                                                    id="subscribe">NHẬN TIN MIỄN PHÍ
                                            </button>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4 text-center">
                                    ...
                                    <div class="content-center-footer">
                                        ...
                                        <p class="desc-footer"><a class="a-text">0933516434</a></p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 text-center">
                                    <div class="icon-footer">
                                    ...
                                    <div class="content-center-footer">
                                        ...
                                        <p class="desc-footer"><a class="a-text" >22521405@gm.uit.edu.vn</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
